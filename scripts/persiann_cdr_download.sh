...
# Data details:
# https://climatedataguide.ucar.edu/climate-data/persiann-cdr-precipitation-\
# estimation-remotely-sensed-information-using-artificial

# Data source.
MAIN_URL="https://www.ncei.noaa.gov/data/precipitation-persiann/access/"

# Where to put downloaded data files.
OUTPUT_FOLDER="/media/alex/ALEXDATA/data_sets/PERSIANN_CDR/"

# Where lives this script.
SCRIPT_FOLDER="/home/alex/Dropbox/repositories/phd/scripts/utils/"
...
#!/home/alex/anaconda3/envs/deepweather/bin/python
